...
import com.example.weatherappyt.viewmodel.WeatherViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.weatherRepository.observe(this) { weather ->
            ...
            binding.apply {
                ...
                val forecast2 = weather.forecast?.get(1)
                val forecast3 = weather.forecast?.get(2)
